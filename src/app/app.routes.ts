...
export const routes: Routes = [
  ...
  { path: 'cursos', component: CursosList, canActivate: [authGuard, adminGuard] },
  ...
  { path: 'cursos/:id', component: CursoDetails, canActivate: [authGuard, adminGuard] },
  ...
  { path: 'professores', component: ProfessorList, canActivate: [authGuard, adminGuard] },
  ...
  { path: 'professores/:id', component: ProfessorDetails, canActivate: [authGuard, adminGuard] },
